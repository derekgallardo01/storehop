        ...
        try {
            stores.forEachIndexed { index, s ->
                ...
                db.execSQL(
                    ...
                    (id, name, colorArgb, isArchived, isSeeded, userId, createdAt, updatedAt, deletedAt, displayOrder, householdId, isOneOff)
                    ...
                    // v0.9: isOneOff = 0 for all seeded stores -- the user
                    // opts a specific store into one-off mode via the
                    // Add/Edit Store toggle.
