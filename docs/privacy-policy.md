...
This policy describes what data the StoreHop Android app ("**StoreHop**", "**we**", "**our**") collects, why, and how we handle it. StoreHop is a personal shopping-list app developed by Derek Gallardo as an independent developer.
...
- Locally, the app keeps a copy of your data on your device in a Room SQLite database so the app works offline.
