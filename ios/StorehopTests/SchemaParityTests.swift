...
final class SchemaParityTests: XCTestCase {
    ...
    func testStoresTableMatchesAndroidSchemaV10() throws {
        // Android schema v10 (v0.9.0) adds the `isOneOff` column for the
        // one-off-stores feature. iOS migration `v9_stores_one_off` adds
        // the same column with the same type / NOT NULL / DEFAULT 0
        // semantics so the wire DTO and Firestore writes converge
        // across platforms.
        try assertColumns(
            table: "stores",
            expected: [
                ...
                ColumnSpec(name: "displayOrder", type: "INTEGER", notNull: true,  defaultValue: "0", pkPosition: 0),
                ColumnSpec(name: "householdId",  type: "TEXT",    notNull: true,  defaultValue: "''", pkPosition: 0),
                ColumnSpec(name: "isOneOff",     type: "INTEGER", notNull: true,  defaultValue: "0", pkPosition: 0),
            ]
        )
    }
