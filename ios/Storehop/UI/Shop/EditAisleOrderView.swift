...
struct EditAisleOrderView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            if viewModel == nil {
                let vm = EditAisleOrderViewModel(
                    storeId: storeId,
    ...
    private func content(viewModel: EditAisleOrderViewModel) -> some View {
        ...
        return List {
            Section {
                Text(String(localized: "edit_aisles_helper"))
            ...
            if viewModel.orderedCategories.isEmpty {
                Section {
                    Text(String(localized: "edit_aisles_empty"))
        ...
        .navigationTitle(
            String(format: String(localized: "edit_aisles_title %@"), storeName)
        )
